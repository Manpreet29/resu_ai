...
# Function to extract LinkedIn and GitHub links
def extract_links(text):
    linkedin = re.findall(r"https?://(?:www\.)?linkedin\.com/(?:in|profile)/[a-zA-Z0-9-_%]+", text, re.IGNORECASE)
    github = re.findall(r"https?://(?:www\.)?github\.com/[a-zA-Z0-9-_%]+", text, re.IGNORECASE)
    return {"linkedin": linkedin[0] if linkedin else "Not Found", "github": github[0] if github else "Not Found"}
